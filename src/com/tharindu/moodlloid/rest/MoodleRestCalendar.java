...
/**
 * 
 * @param calendar : Calendar[]  to store the courseindex,group indexes
 * @param userevents: 1 -true, 0-false 
 * @param siteevents : 1-true,0-false
 * @param timestart : LONG object with the value of from when need events
 * @param timeend : Long object to upto when need events
 * @param ignorehidden : ignore the hidden details;
 ...
 */
	...
	/**
	 * @param calendar[] to represetn the course id,group ids and event id;
	 * @return  calendar[] with event detials
	 * @throws MoodleRestException 
	 * @throws UnsupportedEncodingException
	 */
	public static MoodleCalendar[] getCalendarEvents(MoodleCalendar calendar) throws MoodleRestException, UnsupportedEncodingException {
